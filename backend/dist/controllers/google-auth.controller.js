...
export const googleAuthCallback = async (req, res) => {
    ...
    const state = req.query.state; // Original frontend origin
    ...
    try {
        ...
        if (!student) {
            ...
            if (!userByEmail) {
                return res.redirect(`${frontendUrl}/login?error=google_email_not_found&email=${encodeURIComponent(googleEmail)}`);
            }
 ...
 */
export const googleAuthStatus = (_req, res) => {
    res.json({
