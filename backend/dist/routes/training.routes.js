...
import { getTrainingScoreByStudent, getTrainingScores, getTrainingStatistics, getTrainingScoreById, approveTrainingScore, createTrainingScore, getSubmissionStatus, exportTrainingScoresExcel, submitStudentCustomEvidence, getStudentCustomEvidence, getAllCustomEvidence, reviewCustomEvidence, } from '../controllers/training.controller.js';
...
router.get('/', (req, res, next) => {
    ...
    if (studentId)
        return getTrainingScoreByStudent(req, res);
